...
class Button extends Component
{
    ...
    /**
     * Material Design spec advises that touch targets should be at least 48 x 48 px. To meet this requirement, set this to true.
     *
     * @var boolean
     */
    public $touch = false;
    ...
    /**
     * This is only necessary if you want to avoid potentially overlapping touch targets on adjacent elements (due to collapsing margins).
     *
     * @var boolean
     */
